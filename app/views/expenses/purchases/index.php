...
<form method="GET" action="/expenses/purchases" class="bg-white p-4 rounded-lg shadow-sm border border-gray-200 mb-6">
    <div class="flex flex-col md:flex-row gap-4 items-end">
        ...
        <div class="flex-1 w-full">
            ...
            <input type="text" name="search" value="<?php echo htmlspecialchars($filters['search']); ?>" placeholder="PO Number or Supplier..." class="w-full border p-2 rounded text-sm">
        </div>
...
<div class="flex justify-between items-center mt-4">
    ...
    <div class="flex gap-2">
        <?php 
            // Build base URL for pagination links, keeping current filters
            $params = $_GET; 
