<div class="flex justify-between items-center mb-6">
    <h2 class="text-2xl font-bold text-gray-800">Bill Payments</h2>
    <a href="/expenses/bill-payments/create" class="bg-blue-600 text-white px-4 py-2 rounded shadow hover:bg-blue-700 font-medium">
        <i class="fa-solid fa-money-check-dollar mr-2"></i> New Payment
    </a>
</div>

<form method="GET" action="/expenses/bill-payments" class="bg-white p-4 rounded-lg shadow-sm border border-gray-200 mb-6">
    ...
    <table class="min-w-full divide-y divide-gray-200">
        ...
        <tbody class="divide-y divide-gray-200 bg-white">
            <?php if(empty($payments)): ?>
                <tr><td colspan="5" class="px-6 py-8 text-center text-gray-500 italic">No payments found.</td></tr>
            <?php else: ?>
